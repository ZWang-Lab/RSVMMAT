...
#'
#' This function estimate the parameters and residuals for the NULL model in RSVMMAT
#'
...
rsvmmat_est<-function(y.long, time, y.cov, phe.model = phe.model,maxiter = 50,tol=10^(-6))
{
